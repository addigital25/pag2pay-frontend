...
export default function PlatformProducts() {
  ...
  const loadProducts = async () => {
    try {
      ...
      const response = await fetch('http://localhost:3001/api/platform/products')
      if (!response.ok) {
  ...
  const loadDeletionRequests = async () => {
    try {
      const response = await fetch('http://localhost:3001/api/platform/products/deletion-requests/all')
      if (response.ok) {
        const data = await response.json()
  ...
  const loadDeletedProducts = async () => {
    try {
      const response = await fetch('http://localhost:3001/api/platform/products/deleted-products/all')
      if (response.ok) {
        const data = await response.json()
  ...
  const handleApproveProduct = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:3001/api/platform/products/${selectedProduct.id}/approve`, {
        method: 'PATCH'
      })
  ...
  const handleRejectProduct = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:3001/api/platform/products/${selectedProduct.id}/reject`, {
        method: 'PATCH',
  ...
  const handleSuspendProduct = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:3001/api/platform/products/${selectedProduct.id}/suspend`, {
        method: 'PATCH',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ reason })
      })
  ...
  const handleDeleteProduct = async () => {
    try {
      const response = await fetch(`http://localhost:3001/api/platform/products/${selectedProduct.id}`, {
        method: 'DELETE',
        headers: { 'Content-Type': 'application/json' }
      })
  ...
  const handleApproveRequest = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:3001/api/platform/products/deletion-requests/${selectedRequest.id}/approve`, {
        method: 'PATCH',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
  ...
  const handleRejectRequest = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:3001/api/platform/products/deletion-requests/${selectedRequest.id}/reject`, {
        method: 'PATCH',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          reviewerName: 'Administrador da Plataforma',
